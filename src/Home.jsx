                ...
                <div className="row">
                    <div className="col-10 mx-auto">
                        ...
                        <div className="col-md-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column">
                            ...
                            <div className="mt-3">
                                <NavLink to="/services" className="btn btn-outline-primary king font-weight-bold">-----|| Get Started ||-----</NavLink>
                            </div>

                            <div className="mt-3">
                                <NavLink to="/about" className="btn btn-outline-primary king font-weight-bold">---|| About Us ||---</NavLink>
                            </div><br></br>
