...
const Contact = () => {
    return (
        ...
        <div className="container border B">
            <h1 className="A kpp2">--|| Contact Us ||--</h1><br></br>
            ...
            <div className="row">
                ...
                <form className="pt-4">
                        ...
                        <div className="text-center">
                            <input type="submit" value="Send Message" className="btn btn-outline-primary king font-weight-bold" />
                        </div> <br></br>
                        <div className="text-center font-weight-bold border py-3">
                            <i className="fa fa-map-marker"></i> Vijay Nagar Scheme no. 78, Indore (M.P) <br></br><br></br>
                            <i className="fa fa-envelope"></i> kanhap569@gmail.com <br></br><br></br>
